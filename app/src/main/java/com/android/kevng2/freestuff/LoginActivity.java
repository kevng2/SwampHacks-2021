                ...
                database.getReference("user/" + uid)
                    .addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if (!snapshot.exists()) {
                                DatabaseReference path = database.getReference("user/" + uid);
                                path.child("email").setValue(email);
                                path.child("first_name").setValue(account.getGivenName());
                                path.child("last_name").setValue(account.getFamilyName());
                            }
                        }
